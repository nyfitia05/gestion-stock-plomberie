...
export default function DashboardAdmin({ onLogout }) {
  ...
  // NOUVELLES FONCTIONS POUR MODIFIER / SUPPRIMER ARTICLES
  ...
  // Rendu Stock AVEC BOUTONS MODIFIER / SUPPRIMER
  const renderStock = () => (
    <div style={s.card}>
      <div style={s.cardHead}>
